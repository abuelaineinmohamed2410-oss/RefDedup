# RefDedup
A Python-powered desktop app for detecting and removing duplicate references in RIS/NBIB files. Designed for systematic reviews and meta-analysis workflows.
